...
> **2026 context.** Departmental GenAI adoption has matured. The conversation has shifted from 'should HR/Finance/Marketing use AI' to 'how do we orchestrate AI agents across functions.' The patterns in this chapter remain valid as the foundation; the agentic layer (covered in the [Agentic AI Playbook](/docs/genai-playbook/from-genai-to-agentic-ai/)) builds on top of them.
