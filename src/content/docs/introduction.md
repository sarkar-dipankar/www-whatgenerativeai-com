...
> **2026 context.** This chapter was written in 2024. The core ideas still hold, but the frontier has moved fast: GPT-4o and GPT-5, Claude 4 (Opus/Sonnet), Gemini 2.5, and open models like Llama 3.3 now dominate the landscape. The bigger shift is **agentic AI** — systems that don't just generate, but plan, call tools, and complete multi-step tasks autonomously. For the agentic extension of this material, see the [Agentic AI Playbook](/docs/genai-playbook/from-genai-to-agentic-ai/). For hands-on everyday workflows with ChatGPT, Claude, and Perplexity, see the companion book [AI for Everyday Automation](/book/).
