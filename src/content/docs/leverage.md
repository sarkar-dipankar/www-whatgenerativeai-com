...
> **2026 context.** The tools landscape has consolidated around a few platforms: **ChatGPT** (OpenAI, with GPTs, Custom Instructions, and the Agents SDK), **Claude** (Anthropic, with Projects, Artifacts, and the Claude Agent SDK), **Gemini** (Google, with Gems and the Vertex AI Agent Builder), and **Perplexity** as the leading AI-search tool. **GitHub Copilot**, **Cursor**, and **Windsurf** now own the developer-productivity space. The biggest change since this chapter was written is the rise of **agentic workflows** powered by the Model Context Protocol (MCP) — see [Tools, Function Calling & MCP](/docs/genai-playbook/tools-function-calling-mcp/). For practical, ready-to-use workflows with these tools, see the companion book [AI for Everyday Automation](/book/).
