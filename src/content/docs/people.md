...
> **2026 context.** AI-powered people analytics is now one of the highest-ROI internal GenAI use cases. The ethical guardrails described here are more urgent as agentic systems begin to make autonomous HR decisions — see [Security, Prompt Injection & Governance](/docs/genai-playbook/agents-security-governance/) for the agent-specific risks.
