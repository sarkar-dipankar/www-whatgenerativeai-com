...
> **2026 context.** The limitations described here remain real, but the agentic shift changes the framing. In 2024 the question was 'can this LLM do X'; in 2026 it is 'can an agent that uses this LLM, plus tools, plus verification, reliably do X.' Agents don't eliminate hallucination — they add scaffolding (planning, tool-use, self-check) that contains it. For where agentic systems still fail, see [Evaluating & Observing Agents](/docs/genai-playbook/agents-evals-observability/).
